...
# Cargar el documento limpio
doc = Document(archivo_limpio)

# Ruta de la carpeta donde se guardarán los capítulos
...
# Expresión regular mejorada para detectar títulos correctamente
regex_titulo = re.compile(r"^(PREFACIO|PARTE \d+|CAP[IÍ]TULO \d+|SECCI[ÓO]N \d+|EP[IÍ]LOGO|INTRODUCCI[ÓO]N)", re.IGNORECASE)

# Separar el contenido en diferentes capítulos
...
# Guardar cada sección en un archivo Word separado
